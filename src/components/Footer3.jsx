export default function Footer3() {
  return (
    <div
      id="about"
      className="flex flex-col gap-8 w-full max-w-6xl mx-auto p-4 mt-40 "
    >
      {/* Contact Section */}
      ...
      <div className="bg-[#F4F0F070] rounded-lg p-8 transition-all duration-300 hover:bg-[#F4F0F090] hover:shadow-lg hover:scale-[1.02] cursor-pointer mb-44">
        ...
        <p className="text-white text-center">
          Welcome to Corbett Roar, your gateway to experiencing the wild beauty
          of Jim Corbett National Park. We are dedicated to providing
          unforgettable wildlife experiences while ensuring sustainable and
          responsible tourism practices. Our expert team brings years of local
          knowledge and passion for wildlife conservation to every adventure.
        </p>
      </div>
