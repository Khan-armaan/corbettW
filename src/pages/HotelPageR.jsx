  ...
  const hotels = [
    {
      ...
      paragraph:
        "Welcome to Hridey Retreat Resort, a haven of tranquility nestled in the heart of Jim Corbett, Uttarakhand",
      image: hrideyImg,
      star: 3,
    },
    {
      ...
      location: "Corbett national park\nDhikuli, Ramnagar",
      paragraph:
        "Maya The Forest Resort offers swimming pool, lawns/gardens, massage centre and parking facility.",
    ...
    },
    {
      ...
      location: "Corbett national park\nDhikuli, Ramnagar",
      paragraph:
        " The Atulya Resort is located on the outskirts of the lovely Kumaon Mountains.",
    ...
    },
    {
      ...
      location: "Corbett national park\nDhikuli, Ramnagar",
      paragraph:
        "Welcome to The Jungle Book Corbett, an oasis of refined indulgence and untamed wilderness, nestled amidst the awe-inspiring foothills of the Himalayas.",
      image: jungleImg,
      star: 4,
    },
    {
      ...
      location: "Corbett national park\nDhikuli, Ramnagar",
      paragraph:
        "Located in Dhikuli, Jim Corbett National Park, India, this property is cuddled by nature and nestled by wildlife. ",
      image: maulikImg,
      star: 4,
    },
      ...
      <div className="flex flex-col lg:flex-row gap-12">
        ...
        <div className="flex-1 space-y-8 px-4">
          {hotels.map((hotel, index) => (
            <div
              key={index}
              className="transition-all duration-300 hover:shadow-2xl hover:-translate-y-3 rounded-lg hover:scale-100 mx-auto"
            >
